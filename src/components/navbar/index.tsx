              ...
              <NavigationMenuItem key={link.href}>
                ...
                >
                  <Link
                    href={link.href}
                    onClick={(e) =>
                      link.isScroll && handleSmoothScroll(e, link.href)
                    }
                  >
                    {link.label}
                  </Link>
        ...
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
          ...
          <SheetContent side="right" className="w-[300px] sm:w-[400px]">
            ...
            <div className="flex flex-col gap-4 p-4">
              <Collapsible open={isCourseOpen} onOpenChange={setIsCourseOpen}>
              ...
              {isLoggedIn ? (
                ...
                <Button className="bg-primary w-full mt-4">Login</Button>
              )}
            </div>
          </SheetContent>
        </Sheet>
